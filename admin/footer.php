...
<html>
	...
	<footer>
		...
		<div class="footer-info">
		  <h2 class="contact-medd">Vi svarar g&auml;rna p&aring; dina fr&aring;gor i butiken, p&aring; telefon, e-post, Twitter och Facebook. V&auml;lkommen!</h2>
			...
			<div class="content-footer">
				...
				<div class="bottom-links">
					<ul class="container-bottom-links">
						<li><a class="omlankning" href="omlankning.php">Om l&auml;nkning</a></li>
						...
						<li><a class="allmannavillkor" href="allmannavillkor.php">Allm&auml;nna villkor</a></li>
					</ul>
				</div>	
			</div>
		</div>
