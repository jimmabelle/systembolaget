...
<body>
  <div class="topbar-align">		
	<div class="topbar">
		<div class="barsicon"><a href="#"><i class="fa fa-bars"></i><span class="alladrycker">Drycklista</span></a></div>			
	...
	<div class="container">
		<div class="bolagetslogo"><a href="../index.php"><img src="../img/logo/systembolaget-logo.png" alt="systembolaget logo"></a></div>
			<div class="container-list">
				<ul class="navlist">
					<li><h5 class=""><a class="dryck" href="#">S&ouml;k dryck</a></h5></li>
					...
					<li><h5 class=""><a class="uppdrag" href="#">V&aring;rt uppdrag</a></h5></li>
					<li><h5 class=""><a class="tider" href="#">&Ouml;ppettider</a></h5></li>					
				</ul>
			</div>
	 </div>
